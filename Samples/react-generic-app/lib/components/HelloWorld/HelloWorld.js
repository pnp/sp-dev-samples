    ...
    Hello.prototype.render = function () {
        return (React.createElement("div", { className: HelloWorld_module_scss_1.default.helloWorld },
            React.createElement("div", { className: HelloWorld_module_scss_1.default.container },
                React.createElement("div", { className: office_ui_fabric_react_1.css('ms-Grid-row ms-bgColor-teal ms-fontColor-white', HelloWorld_module_scss_1.default.row) },
                    React.createElement("div", { className: 'ms-Grid-col ms-u-lg10 ms-u-xl8 ms-u-xlPush2 ms-u-lgPush1' },
                        ...
                        React.createElement("p", { className: 'ms-font-l ms-fontColor-white' }, "Building experiences with web stack and modern tooling"),
                        React.createElement("p", { className: 'ms-font-l ms-fontColor-white' }, this.props.description),
                        React.createElement("a", { className: office_ui_fabric_react_1.css('ms-Button', HelloWorld_module_scss_1.default.button), href: 'https://dev.office.com/sharepoint' },
